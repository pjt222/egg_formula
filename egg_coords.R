...
B <- .5 # Abstand zwischen dem Bereich der maximalen Breite und der halben Länge des Eies
DL4 <- 3 # Eidurchmesser (ein Viertel der Eilänge vom spitzen Ende entfernt)
